...
(def catalog
  ...
  {"JPN" {:name "Japan"
   ...
   "CAN-ON" {:name "Canada -- Ontario (exemplar; federalism note below)"
             ...
             :notes "Canada has no federal real-estate regulator -- registration/licensing of agents and brokerages, and real-estate trust-account handling, is regulated per-province; Ontario (RECO) is a provincial exemplar, not a 'Canada' national authority. RECO's own site cites the Act's short title as 'Trust in Real Estate Services Act, 2002 (TRESA)' (retaining the original 2002 enactment year even after the 2020 renaming/amendment, S.O. 2020, c. 1, Sched. 8, in force Dec 1, 2023, which replaced the former Real Estate and Business Brokers Act, 2002); quoted verbatim in :quotes below, not a transcription error introduced here. ontario.ca's own e-laws statute page (https://www.ontario.ca/laws/statute/20t01) requires client-side JavaScript to render body text and could not be directly text-extracted this session -- RECO, the delegated administrative authority for this Act, is cited instead (the same pattern USA-CA above uses: a provincial/state regulator page, not the raw statute text)."
             :quotes
